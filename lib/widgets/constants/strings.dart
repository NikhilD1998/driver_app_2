...
class AppStrings {
  ...
  // DeliveryBoy API endpoints
  static String deliveryBoyEndpoint = "$baseURL/auth";
  static String deliveryBoyByIdEndpoint =
      "$deliveryBoyEndpoint/getDeliveryBoyById";
  static String updateDeliveryBoyEndpoint =
      "$deliveryBoyEndpoint/updateDeliveryBoyById";
  static String deleteDeliveryBoyEndpoint =
      "$deliveryBoyEndpoint/deleteDeliveryBoyById";
  static String allDeliveryBoysEndpoint =
      "$deliveryBoyEndpoint/getAllDeliveryBoys";
  // Error messages
  static const String failedToLoadDeliveryBoyInfo =
      "Failed to load delivery boy information";
  static const String noDeliveryBoyFound = "No delivery boy found";
  static const String noDeliveryBoysFound = "No delivery boys found";
}
